...
- extract actionable implications into `HUMAN_NOTES_AND_FEEDBACK.md`, `METHODS_REFERENCE.md`, `LITERATURE_BASELINES_DATASETS.md`, `EXPERIMENTS_RESULTS.md`, `RESEARCH_ROUTES.md`, or `CURRENT_RESEARCH_DIRECTION.md`;
...
- `docs/METHODS_REFERENCE.md`: mathematical, algorithmic, and implementation gaps.
- `docs/EXPERIMENTS_RESULTS.md`: missing evidence, ablations, metrics, and reproducibility gaps.
- `docs/LITERATURE_BASELINES_DATASETS.md`: novelty, citation, baseline, and related-work gaps.
- `docs/HUMAN_NOTES_AND_FEEDBACK.md`: advisor/senpai questions that are not fully answered.
- `docs/CURRENT_RESEARCH_DIRECTION.md` or `docs/RESEARCH_ROUTES.md`: gaps that affect the paper argument, contribution, lane ranking, or thesis framing.
...
- `docs/EXPERIMENTS_RESULTS.md`: experiment/audit/backlog tasks, metrics, commands, decision gates, and "do not run X until Y" constraints.
- `docs/METHODS_REFERENCE.md`: method relationships, formulas, implementation caveats, source-to-code interpretation, and subspace construction details.
- `docs/LITERATURE_BASELINES_DATASETS.md`: papers, baselines, datasets, reference code, citations, and novelty/comparison pressure.
- `docs/HUMAN_NOTES_AND_FEEDBACK.md`: advisor/senpai/seminar questions and unanswered concerns.
- `docs/CURRENT_RESEARCH_DIRECTION.md`: thesis framing, safe claims, forbidden claims, and current argument structure.
- `docs/RESEARCH_ROUTES.md`: candidate research routes, ranking, win axes, and continue/pause/close decisions.
- `docs/COMMANDS.md`: commands the user is expected to rerun.
...
- Record where the useful knowledge belongs in the active structure:
  - `docs/METHODS_REFERENCE.md` for algorithm details and adaptation ideas;
  - `docs/EXPERIMENTS_RESULTS.md` for candidate experiments and evidence gates;
  - `docs/LITERATURE_BASELINES_DATASETS.md` for paper/code provenance and citation context;
  - `docs/CURRENT_RESEARCH_DIRECTION.md` or `docs/RESEARCH_ROUTES.md` only if it affects the paper-facing research path.
...
```text
docs/ = active research control docs and first reading path
...
- `docs/RESEARCH_ROUTES.md`: candidate research lanes, win axes, ranking, and continue/pause/close gates.
- `docs/METHODS_REFERENCE.md`: methods, formulas, construction cards, source-to-code trails, and implementation caveats.
- `docs/EXPERIMENTS_RESULTS.md`: compact evidence table for completed and pending experiments.
- `docs/LITERATURE_BASELINES_DATASETS.md`: papers, datasets, baselines, bookmarks, and reference-code context.
- `docs/HUMAN_NOTES_AND_FEEDBACK.md`: Sensei/senpai/seminar feedback and resulting decisions.
- `docs/COMMANDS.md`: exact commands.
- `docs/DISTILLATION_REVIEW.md`: coverage/deletion dashboard for old notes, research docs, KB files, and AI-generated synthesis.
...
For subspace experiments, always explain subspace construction first. Use the construction-card fields from `docs/METHODS_REFERENCE.md`: variant name, source/reference, sample unit, input matrix/tensor, subspace count, basis shape, fitting method, comparison/score, spatial information preserved/lost, code path, and verification. This is seminar-critical; do not assume "we build a subspace" is enough explanation.
