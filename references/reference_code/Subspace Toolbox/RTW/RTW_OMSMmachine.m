...
function Results = RTW_OMSMmachine(X1,X2,TrnLabels,TestLabels,k,n,SubDim,ClassSubDim)
...
[Results,Time,S] = OMSM_MachineUnbalanced(T1,T2,TrnLabels,TestLabels,SubDim,ClassSubDim);
end
