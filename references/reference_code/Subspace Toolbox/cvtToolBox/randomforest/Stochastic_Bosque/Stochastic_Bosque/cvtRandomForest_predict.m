function [predict_l f_votes]= cvtRandomForest_predict(test_x, Random_Forest, varargin)
%[f_output f_votes]= eval_Stochastic_Bosque(Data,Random_Forest,varargin)
...
[predict_l f_votes]= eval_Stochastic_Bosque(test_x',Random_Forest,varargin);
